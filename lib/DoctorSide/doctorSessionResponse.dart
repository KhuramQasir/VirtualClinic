...
class DoctorSessionResponse extends StatefulWidget {
  final String date;

  DoctorSessionResponse({required this.date});

  @override
  State<DoctorSessionResponse> createState() => _DoctorSessionResponseState();
}

class _DoctorSessionResponseState extends State<DoctorSessionResponse> {
