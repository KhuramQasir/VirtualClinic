...
class PatientHomeNavigation extends StatefulWidget {
  const PatientHomeNavigation({Key? key}) : super(key: key);

  @override
  State<PatientHomeNavigation> createState() => _PatientHomeNavigationState();
}

class _PatientHomeNavigationState extends State<PatientHomeNavigation> {
        ...
        title: Row(
          children: [
            ...
            IconButton(onPressed: (){
               logoutDoctor(patientid.toString());
