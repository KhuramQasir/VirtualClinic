...
class AdminPatientInfo extends StatefulWidget {
  @override
  _AdminPatientInfoState createState() => _AdminPatientInfoState();
}

class _AdminPatientInfoState extends State<AdminPatientInfo> {
...
void main() {
  runApp(MaterialApp(home: AdminPatientInfo()));
}
